...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { description: @reminder.description, due_date: @reminder.due_date, repeat_frequency: @reminder.repeat_frequency, title: @reminder.title } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { description: @reminder.description, due_date: @reminder.due_date, repeat_frequency: @reminder.repeat_frequency, title: @reminder.title } }
